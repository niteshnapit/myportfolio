            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    if (isset($_REQUEST['deleteblogpost'])) {
                        ...
                        } elseif ($_REQUEST['deleteblogpost'] == "error") {
                            echo "<div class='alert alert-danger'>
                                                <strong>Error!</strong> Blog Post wasn't Deleted due to an unexpected error!.
                                                </div>";
                        }
                    }
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-toggle="modal" data-target="#delete<?php echo $id; ?>">Delete</button>
                                                </td>
                                            </tr>
